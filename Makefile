...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile MeltingSimulation.pro
#############################################################################
...
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/home/i7435906/NGL/lib -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/home/i7435906/NGL/lib -l NGL -ltiff -L/opt/qt/5.5/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/main.cpp \
		...
		src/ReadGeo.cpp moc/moc_OpenGLWindow.cpp
OBJECTS       = obj/main.o \
...
Makefile: MeltingSimulation.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		/opt/qt/5.5/gcc_64/mkspecs/features/declarative_debug.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile MeltingSimulation.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/main.cpp src/SimulationController.cpp src/Emitter.cpp src/Particle.cpp src/Grid.cpp src/OpenGLWindow.cpp src/MathFunctions.cpp src/Grid_deviatoricVelocity.cpp src/Grid_pressureVelocity.cpp src/Grid_Temperature.cpp src/ReadGeo.cpp $(DISTDIR)/
